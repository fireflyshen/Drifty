...
export const copy = {
  zh: {
    language: 'EN', languageLabel: 'Switch to English', subtitle: '数据库模型注册表', search: '搜索模型、字段、项目…', manifests: '项目清单', readOnly: '公开只读',
    ...
    noMatches: '没有符合条件的字段。', selectHint: '已选中', affected: '个受影响项目', fetchError: 'D1 暂时不可用。', readonlyNote: '公开版本为只读模式；写入接口已关闭。', dismiss: '关闭提示',
    low: '低', medium: '中', high: '高', draft: '草稿', review: '审核中', approved: '已通过', registered: '已登记',
  },
  en: {
    language: '中文', languageLabel: '切换到中文', subtitle: 'Schema registry', search: 'Search schemas, fields, projects…', manifests: 'Manifests', readOnly: 'Public read-only',
    ...
    noMatches: 'No fields match this view.', selectHint: 'Selected', affected: 'affected projects', fetchError: 'D1 is temporarily unavailable.', readonlyNote: 'The public site is read-only; write endpoints are disabled.', dismiss: 'Dismiss',
