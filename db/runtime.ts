...
export async function ensureDatabase() {
  ...
  if (!importColumns.results.some((column) => column.name === 'raw_sql')) await db.prepare(`ALTER TABLE import_batches ADD COLUMN raw_sql text DEFAULT '' NOT NULL`).run();
